...
import { fetchUsers, createUser, changePassword, deleteUser } from "../api/manage";
  ...
  return (
    <>
      ...
      <main className="container" style={{ padding: "2rem 1.5rem" }}>
                    ...
                    <td>
                      <div className="user-actions">
                        <button
                          ...
                          onClick={() => { setChangingUser(user); setNewPwd(""); setError(""); }}
                        >
                          Password
                        </button>
                        <button
        ...
        {changingUser && (
          <div className="modal-overlay" onClick={() => setChangingUser(null)}>
            <div className="modal" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleChangePassword}>
                ...
                {error && <div className="form-error">{error}</div>}
                <div className="modal-actions">
                  <button type="button" className="btn btn-secondary" onClick={() => setChangingUser(null)}>
                    Cancel
                  </button>
                  <button type="submit" className="btn btn-primary" disabled={saving}>
